...
test_data_path = r'E:\Latest\Test-Datac.xlsx'
predicted_data_path = r'E:\Latest\naive_bayes_predictions.xlsx'
...
y_pred = predicted_data['Similarity Score']  # Replace with the actual column name for predicted similarity score
...
plt.title('Confusion Matrix for Random Forest Classifier', fontsize=12, fontweight='bold')  # Reduced font size
...
confusion_matrix_image_path = r'E:\Latest\dt.png'
plt.tight_layout()
...
evaluation_metrics_image_path = r'E:\Latest\dt_metric.png'
plt.tight_layout()
